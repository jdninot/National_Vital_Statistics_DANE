...
# Lectura de archivos --------------------
Poblacion_indigenas_DANE <- read_excel("C:\\\\DANE\\Demografía y población\\Autoreconocimiento étnico\\Autoreconocimiento_étnico_CNPV_2018.xlsx", sheet = "Indígena")
...
View(Poblacion_indigenas_DANE_2)

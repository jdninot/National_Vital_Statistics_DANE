...
# Combinacion de años --------------------
Poblacion_defunciones_DANE <- rbind(Poblacion_defunciones_DANE_2018[, c("CAUSA_667", "EMB", "CODPTORE", "IDPERTET", "ANO", "SEXO", "GRU_ED1")], 
                                    Poblacion_defunciones_DANE_2019[, c("CAUSA_667", "EMB", "CODPTORE", "IDPERTET", "ANO", "SEXO", "GRU_ED1")],
                                    Poblacion_defunciones_DANE_2020[, c("CAUSA_667", "EMB", "CODPTORE", "IDPERTET", "ANO", "SEXO", "GRU_ED1")],
                                    Poblacion_defunciones_DANE_2021[, c("CAUSA_667", "EMB", "CODPTORE", "IDPERTET", "ANO", "SEXO", "GRU_ED1")])
...
Poblacion_defunciones_DANE_1 <- Poblacion_defunciones_DANE %>%
  ...
  group_by(CAUSA_667, EMB, CODPTORE, IDPERTET, ANO, SEXO, Grupo_Etario) %>%
...
Poblacion_defunciones_DANE_2 <- reshape2::dcast(Poblacion_defunciones_DANE_1, CAUSA_667 + EMB + CODPTORE + IDPERTET + ANO + Grupo_Etario ~ SEXO, fun.aggregate = sum)
...
Poblacion_defunciones_DANE_3 <- Poblacion_defunciones_DANE %>% 
  ...
  group_by(CAUSA_667, EMB, CODPTORE, IDPERTET, ANO, SEXO) %>%
  # Se filtra las filas por departamento de estudio
  filter(CODPTORE %in% c(11, 19, 91, 95)) %>%
  # Se filtra los grupos etnicos - raciales
  filter(IDPERTET %in% c(1, 2, 3, 4, 5)) %>%
...
Poblacion_defunciones_DANE_4 <- reshape2::dcast(Poblacion_defunciones_DANE_3, CAUSA_667 + EMB + CODPTORE + IDPERTET + ANO ~ SEXO, fun.aggregate = sum)
...
Poblacion_defunciones_DANE_5 <- Poblacion_defunciones_DANE %>%
  ...
  group_by(CAUSA_667, EMB, IDPERTET, ANO, SEXO, Grupo_Etario) %>%
  # Se filtra los grupos etnicos - raciales
  filter(IDPERTET %in% c(1, 2, 3, 4, 5)) %>%
  # Se filtra por muerte natural y mujeres embarazadas en las ultimas 6 semanas
  filter(CAUSA_667 == 612, EMB == 1) %>%
...
Poblacion_defunciones_DANE_6 <- reshape2::dcast(Poblacion_defunciones_DANE_5, CAUSA_667 + EMB + IDPERTET + ANO + Grupo_Etario ~ SEXO, fun.aggregate = sum)
...
Poblacion_defunciones_DANE_7 <- Poblacion_defunciones_DANE %>% 
  # Se agrupa los datos por las columnas CODPTORE, ANO y SEXO
  group_by(CAUSA_667, EMB, IDPERTET, ANO, SEXO) %>%
  # Se filtra los grupos etnicos - raciales
  filter(IDPERTET %in% c(1, 2, 3, 4, 5)) %>%
  # Se filtra por muerte natural y mujeres embarazadas en las ultimas 6 semanas
  filter(CAUSA_667 == 612, EMB == 1) %>%
...
# se aplica dcast por sexo para totales generales --------------------
Poblacion_defunciones_DANE_8 <- reshape2::dcast(Poblacion_defunciones_DANE_7, CAUSA_667 + EMB + IDPERTET + ANO ~ SEXO, fun.aggregate = sum)
...
Poblacion_defunciones_DANE_9 <- Poblacion_defunciones_DANE_9[order(Poblacion_defunciones_DANE_9$Departamento, Poblacion_defunciones_DANE_9$Pertenencia_etnica, Poblacion_defunciones_DANE_9$ANO, Poblacion_defunciones_DANE_9$Grupo_Etario), c(8, 3, 1, 2, 9, 4:7)]
colnames(Poblacion_defunciones_DANE_9) <- c("Departamento", "CODPTORE", "CAUSA_667", "EMB", "Pertenencia étnica", "IDPERTET", "Año", "Grupo Etario", "Muertes maternas")

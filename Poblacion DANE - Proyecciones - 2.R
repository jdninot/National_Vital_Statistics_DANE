...
# Lectura de archivos --------------------
Poblacion_DANE <- read_excel("C:/Users/epidemiologia/Datos/DANE/Demografía y población//Proyecciónes de poblacion//ProyeccionesPD - Formato ancho 20231103.xlsx", sheet = "2018-2023")
...
lim <- c(0, 14, 19, 24, 29, 39, 44, 49, 59, 64, Inf)
...
########################################################################
################### Totales generales >= 15 ############################
########################################################################

# Filtrado mayores de 18 años --------------------
Poblacion_DANE_melt_7 <- Poblacion_DANE_melt_6 %>% filter(Grupo_Etario != "De 0 a 14 años", Grupo_Etario != "Total general")
...
# Guardar enterno --------------------
# save.image("C:\\Users\\Datos\\DANE\\Demografía y población\\Proyecciónes de poblacion\\ProyeccionesPD - Formato largo 20231103.RData")

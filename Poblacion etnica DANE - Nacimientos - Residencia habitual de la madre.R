...
# Lectura de archivos --------------------
Poblacion_nacimientos_DANE_2018 <- read.csv("C:\\Users\\Estadísticas Vitales - EEVV\\EEVV - 2018\\nac2018 20231025.csv")
Poblacion_nacimientos_DANE_2019 <- read.csv("C:\\Users\\Estadísticas Vitales - EEVV\\EEVV - 2019\\nac2019 20231025.csv")
Poblacion_nacimientos_DANE_2020 <- read.csv("C:\\Users\\Estadísticas Vitales - EEVV\\EEVV - 2020\\nac2020 20231025.csv")
Poblacion_nacimientos_DANE_2021 <- read.csv("C:\\Users\\Estadísticas Vitales - EEVV\\EEVV - 2021\\nac2021 20231025.csv")
...
Poblacion_nacimientos_DANE_1 <- Poblacion_nacimientos_DANE %>%
  ...
  group_by(IDPERTET, CODPTORE, ANO, SEXO) %>%
  # Se filtra las filas por departamento de estudio y grupo etnico
  filter(IDPERTET %in% c(1, 2, 3, 4, 5), CODPTORE %in% c(11, 19, 91, 95)) %>%
...
Poblacion_nacimientos_DANE_2 <- reshape2::dcast(Poblacion_nacimientos_DANE_1, IDPERTET + CODPTORE + ANO ~ SEXO, fun.aggregate = sum)

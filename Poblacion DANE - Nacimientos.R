...
# Lectura de archivos --------------------
Poblacion_nacimientos_DANE_2018 <- read.csv("C:\\Users\\ASUS TUF\\\EEVV - 2018\\nac2018 20231025.csv")
Poblacion_nacimientos_DANE_2019 <- read.csv("C:\\Users\\ASUS TUF\\\EEVV - 2019\\nac2019 20231025.csv")
Poblacion_nacimientos_DANE_2020 <- read.csv("C:\\Users\\ASUS TUF\\\EEVV - 2020\\nac2020 20231025.csv")
Poblacion_nacimientos_DANE_2021 <- read.csv("C:\\Users\\ASUS TUF\\\EEVV - 2021\\nac2021 20231025.csv")
...
Poblacion_nacimientos_DANE_2 <- reshape2::dcast(Poblacion_nacimientos_DANE_1, COD_DPTO + ANO ~ SEXO, fun.aggregate = sum)
